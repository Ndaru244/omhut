    <main class="container mt-2">
        <div class="row">
            ...
            <div class="col-11">
                ...
                <h3 class="text-center"><b>Menu Minuman</b></h3>
            </div>
                    ...
                    <div class="row g-0">
                        <div class="col-5">
                            <div class="card-body border-0 p-0">
                                <img src="<?= base_url('assets/images/').$drink->gambar_menu; ?>" class="img-fluid rounded-3" alt="">
                            </div>
                        </div>
                        <div class="col-7">
                            <div class="card-body">
                                <h3 class="card-title"><b><?= $drink->nama_menu; ?></b></h3>
                                <p class=" card-subtitle text-body-secondary">Rp.<?= number_format($drink->harga_menu, 0, ',', '.'); ?></p>
                                <p class="card-text pt-2"><small class="text-body-secondary d-grid gap-2">
                                <?= $drink->status_menu!='tersedia' ? '
                                    <button type="button" class="btn btn-danger"><b>Kosong</b></button>
                                    ' : '
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#detailDrink" class="btn btn-primary btn-open-modal" data-item-id="'.$drink->id_menu.'" data-item-image="'.$drink->gambar_menu.'" data-item-name="'.$drink->nama_menu.'" data-item-price="'.$drink->harga_menu.'"><b>Pesan</b></button>
                                    ' ?>
                                </small></p>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="detailDrink" data-bs-backdrop="static" aria-labelledby="detailDrinkLabel" aria-hidden="true" tabindex="-1">
                        ...
                        <div class="col-sm">
                            <div class="card border-0 rounded-3 shadow-sm mb-3" style="max-width: 100%;">
                                <div class="row g-0">
                                    ...
                                    <div class="col-7">
                                        <div class="card-body">
                                            <h3 class="card-title" id="item-name"></h3>
    ...
    <script>
        $(document).ready(function () {
            $('.btn-open-modal').click(function () {
                ...
                $('#detailDrink .modal-title').text(itemName);
                $('#detailDrink #item-id').val(itemId);
                $('#detailDrink #item-image').attr('src',itemImage);
                $('#detailDrink #item-name').text(itemName);
                $('#detailDrink #item-price').text(itemPrice);
            ...
            $('#orderForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        setTimeout(function() {
                            window.location.href = '<?= base_url('main/menu_minuman')?>';
                        },500)
