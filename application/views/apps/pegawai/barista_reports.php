        ...
        <div class="col-lg-12">
            <div class="card px-0 py-0 border-0 rounded-3 shadow-sm">
                <nav class="px-4 pt-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="link-custom" href="<?= base_url('barista/') ?>"><b>Barista</b></a></li>
        ...
        <div class="col-lg-12 mt-2">
            <div class="card border-0 rounded-3 shadow-sm">
                <div class="card-header bg-white text-center">
                    <p class="card-title text-center h5 mt-2"><b>Laporan Barista</b><br> <?= $user['role_pegawai'] ?>: @<?= $user['username_pegawai'] ?></p>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        $('#records').DataTable({
            ...
            ajax: {
                url: "<?= base_url('barista/fetch_report') ?>",
                type: "POST",
                dataType: "json",
                dataSrc: ""
            },
