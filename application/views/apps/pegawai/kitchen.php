        ...
        <div class="col-lg-4 mb-2">
            <div class="card text-light border-0 rounded-3 shadow">
                ...
                <div class="card-content">
                    <a href="<?= base_url('kitchen/report') ?>">
            ...
            <div class="card border-0 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    <div class="alert alert-info d-flex align-items-center" role="alert">
                        ...
                        <div>
                            Klik tombol <span class="badge bg-primary"><b>Konfirmasi</b></span> untuk membuat pesanan, dan klik tombol <span class="badge bg-success"><b>Selesai</b></span> jika pesanan siap diantar.
                        </div>
                    </div>
...
<script>
    ...
    function fetchOrders() {
        $.ajax({
            url: "<?php echo base_url('kitchen/fetch_orders'); ?>",
            method: "GET",
            dataType: "json",
    ...
    $(document).on('click','#confirmOrder', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('kitchen/confirm_order/') ?>' + idDetail,
            type: 'POST',
            dataType: 'json',
            success: function(data) {
    ...
    $(document).on('click','#finishOrder', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('kitchen/finish_order/') ?>' + idDetail,
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                if (data.responce === 'success') {
