...
class Barista extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($user_id) {
      ...
      $this->load->view('apps/pegawai/barista',$data);
  ...
  public function report()
  {
    ...
    $data['report'] = "Laporan";
    $this->load->view('apps/pegawai/frame/header',$data);
    $this->load->view('apps/pegawai/barista_reports',$data);
    $this->load->view('apps/pegawai/frame/footer');
  }
  ...
  public function fetch_report()
  {
    if ($this->input->is_ajax_request()) {
      $detailOrder = $this->Admin_model->get_orders_chef('minuman');
...
/* End of file Barista.php */
/* Location: ./application/controllers/Barista.php */